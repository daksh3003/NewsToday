...
export class News extends Component {
  ...
  handleNextClick = async ()=>{
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=f8373ecf5d2a4e099fbc165f4424db5d&page=${this.state.page+1}&pageSize=${this.props.pageSize}`;
